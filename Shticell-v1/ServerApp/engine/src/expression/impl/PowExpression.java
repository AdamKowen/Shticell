...
public class PowExpression implements Expression {
    ...
    public EffectiveValue eval(SheetReadActions sheet) {
        ...
        for(int i =2; i <= rightValue.extractValueWithExpectation(Double.class); i++) //calculated the pow rounded down
        {
            result *= leftValue.extractValueWithExpectation(Double.class);
        }
